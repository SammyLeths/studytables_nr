      ...
      <td>
        <table className="w-full table-auto border border-collapse border-slate-200">
          <tbody>
            <tr className="h-10">
              ...
              <td className="m-0 p-0 border border-slate-200 h-10 cursor-pointer">
                <div className="flex justify-between items-center h-[100%]">
                  ...
                  <div className="px-3 hidden" onClick={toggleRow}>
                    {isOpen ? (
            ...
            <tr className="h-10">
              <th className="px-4 border border-slate-200">Price (Intraday)</th>
              <td
            ...
            <tr className="h-10">
              <th className="px-4 border border-slate-200">PE Ratio (TTM)</th>
              <td
                className={`px-4 border border-slate-200 cursor-pointer ${
            ...
            <tr className="h-10">
              <th className="px-4 border border-slate-200">52 Week Range</th>
              <RangeCell
